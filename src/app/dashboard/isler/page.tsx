      ...
      <div className="md:hidden flex h-full min-h-0 flex-col bg-[#030712] text-white">
        {mobileView === 'list' && (
          <div className="flex h-full min-h-0 flex-col">
            <div className="shrink-0 border-b border-slate-800 bg-[#030712] px-4 pb-4 pt-[104px] md:pt-4">
        ...
        {mobileView === 'detail' && aktifIs && (
          <div className="flex h-full min-h-0 flex-col">
            <div className="shrink-0 border-b border-slate-800 bg-[#030712] px-4 pb-3 pt-[104px] md:pt-3">
              <div className="flex items-center justify-between gap-3">
                <button
                  onClick={() => setMobileView('list')}
                  className="rounded-xl border border-slate-700 bg-[#0B1120] px-4 py-3 text-sm font-bold min-w-[96px]"
                >
                  ← İşler
                </button>
