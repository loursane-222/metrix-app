...
<div className="min-h-[100dvh] bg-[#030712] text-white overflow-hidden flex">
      ...
      <aside className="hidden 2md:flex w-[24%] border-r border-slate-800 flex-col">
      ...
      <main className="relative min-h-[100dvh] w-full 2md:w-[51%] overflow-y-auto px-4 pb-[calc(env(safe-area-inset-bottom)+110px)] pt-[calc(env(safe-area-inset-top)+168px)] 2md:p-6">
      ...
      <aside className="hidden 2md:flex w-[25%] border-l border-slate-800 p-6 flex-col min-h-0">
    ...
    <span className="ml-1 text-xs text-slate-400">TL</span>
      ...
      {/* MOBILE FLOATING WIZARD ACTIONS */}
