      ...
      >
        <div>
          ...
          <p style={{ margin: 0, fontSize: '13px', color: '#9ca3af' }}>
            {personeller.length}/50 personel
          </p>
        </div>
            ...
            >
              <div
                style={{
                  ...
                  height: '32px',
                  borderRadius: '50%',
                  background: idx === 0 ? '#fef9c3' : idx === 1 ? '#f3f4f6' : '#fef3c7',
                  display: 'flex',
                  alignItems: 'center',
              ...
              <div style={{ textAlign: 'center', minWidth: '120px' }}>
                <div
                  style={{
                    fontSize: '28px',
                    fontWeight: '800',
                    color: performansRenk(p.performansNotu),
                    lineHeight: 1
                  }}
                >
          ...
          >
            ...
            >
              <h3 style={{ margin: 0, fontSize: '18px', fontWeight: '700' }}>
                {duzenleId ? 'Personel Düzenle' : 'Personel Ekle'}
              </h3>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px' }}>
              ...
              <div>
                <label style={labelStil}>Görevi</label>
                <select
                  style={inputStil}
                  value={form.gorevi}
              ...
              <div>
                <label style={labelStil}>Kıdem (Çalışma Yılı)</label>
                <input
                  style={inputStil}
                  type="number"
                  min="0"
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '10px', marginTop: '20px' }}>
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: '600',
                  cursor: 'pointer',
                  opacity: !form.ad || !form.soyad ? 0.5 : 1
                }}
              >
