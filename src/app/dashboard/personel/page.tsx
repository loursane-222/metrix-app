...
>
  + Personel
        ...
        <main className={`rounded-3xl border border-slate-800 bg-[#0B1120] px-4 pb-28 pt-[104px] md:p-5 md:overflow-hidden ${mobileView === "detail" ? "block overflow-y-auto" : "hidden md:block"}`}>
          {!aktif ? (
            ...
            <div className="flex h-full flex-col">
              <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                <div className="flex items-center justify-between gap-3 md:hidden">
                  <button
                    onClick={() => { setMobileView('list'); setMobilePanelOpen(false) }}
                ...
                <div>
                  ...
                  <h2 className="mt-2 break-words text-2xl font-semibold leading-tight md:text-3xl">{aktif.ad} {aktif.soyad}</h2>
              ...
              <div className="mt-5 grid grid-cols-1 gap-4 lg:grid-cols-[1fr_0.82fr]">
    ...
    {aktif && (
      ...
      {formAcik && (
        <div className="fixed inset-0 z-[300] flex items-center justify-center bg-black/70 p-4" onClick={() => setFormAcik(false)}>
          <div className="max-h-[90dvh] w-full max-w-2xl overflow-y-auto rounded-3xl border border-slate-800 bg-[#0B1120] p-5 md:p-6 text-white shadow-2xl" onClick={e => e.stopPropagation()}>
